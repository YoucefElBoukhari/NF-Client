...
function Facture() {
    ...
    <hr className="my-2 border-gray-400" />
      ...
      <div className="mb-1">
        <span className="block border border-red-300 p-2 rounded-lg text-black">TVA:&nbsp;&nbsp;&nbsp;&nbsp;<span className="text-red-500">{(somme1 * 0.2).toLocaleString()}Dh</span> </span> 
      </div>
      <div className="mb-1">
    ...
    <span className="text-red-500">
      {(somme1 + (somme1 * 0.2)).toLocaleString()}Dh
    </span>
    </span>
    </div>
    </div>
